...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-1/2 -translate-x-1/2 flex items-center justify-center gap-6 mt-auto mb-8 h-fit w-fit z-10 bg-stone-200/75 dark:bg-stone-800/75 backdrop-blur-md rounded-full">
